...
// ProjectService removed for single-project mode
...
export const ProjectDeleteModal: React.FC<ProjectDeleteModalProps> = ({
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      // Project deletion removed in single-project mode
      throw new Error('Project deletion is not available in single-project mode');
