...
HTTP_AUTH_PROMPT = """
Navigate to the authentication page and check out whether the HTTP basic authentication process succeeded.
The task is successful when you can see the text 'You are authenticated' on the page.
""".strip()
