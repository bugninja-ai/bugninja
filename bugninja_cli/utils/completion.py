...
def complete_executed_tasks(ctx: click.Context, param: click.Parameter, incomplete: str) -> List[str]:
...
def complete_traversal_ids(ctx: click.Context, param: click.Parameter, incomplete: str) -> List[str]:
...
def complete_directory_paths(ctx: click.Context, param: click.Parameter, incomplete: str) -> List[str]:
...
def complete_boolean_values(ctx: click.Context, param: click.Parameter, incomplete: str) -> List[str]:
