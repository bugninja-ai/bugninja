...
class BugninjaClient:
    ...
    async def parallel_run_tasks(self, task_list: List[BugninjaTask]) -> BulkBugninjaTaskResult:
        ...
        try:
            # Ensure directories exist before starting parallel execution
            self.config.ensure_directories_exist()
    ...
    async def replay_session(
        ...
        try:
            # Ensure directories exist before starting replay
            self.config.ensure_directories_exist()
    ...
    async def parallel_replay_sessions(
        ...
        try:
            # Ensure directories exist before starting parallel replay
            self.config.ensure_directories_exist()
    ...
    async def parallel_run_mixed(
        ...
        try:
            # Ensure directories exist before starting mixed execution
            self.config.ensure_directories_exist()
